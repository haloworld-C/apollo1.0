...
Status LatController::ComputeControlCommand(
  ...
  steer_angle = digital_filter_.Filter(50);*/
  double steer_angle = 50.0;
  double steer_rate = 0.1;
  cmd->set_steering_target(steer_angle);              //cmd->set_steering_target(steer_angle);
